...
class BotClassifier:
    ...
    def train(self):
        ...
        trainingData.append({"class":"General", "sentence":"yo"})
        trainingData.append({"class":"General", "sentence":"you"})
        ...
        trainingData.append({"class":"Booking", "sentence":" want to book a train to  Colchester at 12:00 am with a return ticket"})
        ...
        trainingData.append({"class":"Booking", "sentence":" want to a return ticket to Alton from "})
        ...
        trainingData.append({"class":"Booking", "sentence":"Can I get a ticket from  to Dalmarnock"})
        ...
        trainingData.append({"class":"Booking", "sentence":"i want to book a train High  (Glasgow) from Hertford North"})
        trainingData.append({"class":"Booking", "sentence":"i want to book a train to  from Hillington East"})
        ...
        trainingData.append({"class":"Booking", "sentence":"time 13:00"})
        trainingData.append({"class":"Booking", "sentence":" time 12:00"})
        trainingData.append({"class":"Booking", "sentence":"single single"})
        trainingData.append({"class":"Booking", "sentence":"double double"})
        trainingData.append({"class":"Booking", "sentence":" time 22:00"})


        trainingData.append({"class":"Model", "sentence":"how often is the train late"})
        trainingData.append({"class":"Model", "sentence":"i have a delay"})
        trainingData.append({"class":"Model", "sentence":" expected delay"})
        trainingData.append({"class":"Model", "sentence":"delay"})
        trainingData.append({"class":"Model", "sentence":"i departed from "})
        trainingData.append({"class":"Model", "sentence":"i left from "})
        trainingData.append({"class":"Model", "sentence":"i left to "})
        trainingData.append({"class":"Model", "sentence":"expected arrival time is"})
        trainingData.append({"class":"Model", "sentence":"i am expected to arrive at"})
        trainingData.append({"class":"Model", "sentence":"i am having a delay while i am going to "})
        trainingData.append({"class":"Model", "sentence":"how long will my delay be?"})
        trainingData.append({"class":"Model", "sentence":" late?"})
        trainingData.append({"class":"Model", "sentence":"with the delay, what time will we arrive at the destiniation?"})
        trainingData.append({"class":"Model", "sentence":"how often  late"})
