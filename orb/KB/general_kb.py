...
pairs = (
    ...
    (
        r'(To book.*)',
        (
            "Ok lets book a train, what station are you leaving from",
        ),
    ),
    (
        r'To book(.*)',
    ...
    (
        r'(.*)a Gremlin (.*)',
        (
            " %1a gremlin it went bang %2",
        ),
    ),
    (
        r'(.*)Rick & Morty',
        (
            "Sorry, my IQ isn't high enough to appreciate Rick & Morty.",
        ),
    ),
    (
        r'South Park(.*)',
        (
            "Are you cereal? I love South Park!",
        ),
    ),
    (
        r'(.*)dalek',
    ...
    (
        ...
        (
            ...
            "is cool",
            "shiney",
            "hello humans i make this look cool",
        ),
    ),
    (
        r'(.*)airplane',
        (
            "Can't do airplanes sorry!",
        ),
    ),
    (
        r'(.*)Richard',
        (
            "Richard is my creator",
        ),
    ),
    (
        r'(.*)Wenjia',
    ...
    (
        r'(.*)Christmas',
        (
            "Christmas is close baby!",
        ),
    ),
    (
        r'(.*)couples',
        (
            "omg couples they never shut it!",
        ),
    ),
    (
        r'(.*)artificial intelligence',
        (
            "AI will take over the world whether you want it or not!",
        ),
    ),
    (
        r'(.*)coursework',
        (
            "I've heard AI coursework is challenging",
        ),
    ),
    (
        r'(.*)Gremlin',
    ...
    (
        ...
        (
            ...
            "I loved the part where he got shot with arrows lol.",
        ),
    ),
    (
        r'(.*)I need (.*)',
...
(
        r'Swellow (.*)',
        (
            "It is the greatest Pokemon of them all",
            "It's so strong even anime Pikachu couldnt kill it",
            "Boomburst or Facade? I love both!",
            "Better than Staraptor. Haters gonna hate",
        ),
    ),
    (
        r'(.*) sorry (.*)',
